...
1. 翻訳フェーズ
    ...
    1. 適宜リンク追加[^n]
    1. 翻訳の改善   
        - wikipeの書き方を参考にする =done
        - wikiaの他のページから書き方を合わせる =done
        - コミュニティに表現を相談する =そのうち
1. wikia表記に直すフェーズ =done
...
1. ひと段落したところで書いた今後のフェーズ
    - リストとかインフォボックスの作成
        - 主要勢力を二行に =oK
        - rwbyインフォボックス:日wikiにあるのかな =なかった
    - 細かいの
        - 最初のコロン抜けてる =done
        - 主要な勢力 -> 主要勢力 =done
        - リンクがなんかキレてる =英wikiも切れいるので無視
    - 全角スペースを半角スペースに =done
    - 迷っていた表現をまとめて、コミュニティに聞く =できなさそう
    - カテゴリ追加 =よくわからなかった
